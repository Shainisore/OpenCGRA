//========================================================================
// VCGRARTL__1d39f2e940519f92_v.cpp
//========================================================================
...
#include "obj_dir_CGRARTL__1d39f2e940519f92/VCGRARTL__1d39f2e940519f92.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_CGRARTL__1d39f2e940519f92/VCGRARTL__1d39f2e940519f92__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void trace( VCGRARTL__1d39f2e940519f92_t *, char * );
  #endif
...
VCGRARTL__1d39f2e940519f92_t * create_model( const char *vcd_filename ) {

  VCGRARTL__1d39f2e940519f92_t * m;
  VCGRARTL__1d39f2e940519f92   * model;

  Verilated::randReset( 0 );

  m     = (VCGRARTL__1d39f2e940519f92_t *) malloc( sizeof(VCGRARTL__1d39f2e940519f92_t) );
  model = new VCGRARTL__1d39f2e940519f92();
...
void destroy_model( VCGRARTL__1d39f2e940519f92_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VCGRARTL__1d39f2e940519f92 * model = (VCGRARTL__1d39f2e940519f92 *) m->model;
...
void eval( VCGRARTL__1d39f2e940519f92_t * m ) {
...
#if VLINETRACE
void trace( VCGRARTL__1d39f2e940519f92_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_CGRARTL__1d39f2e940519f92__v );
